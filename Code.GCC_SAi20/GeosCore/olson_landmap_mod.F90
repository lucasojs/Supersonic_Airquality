...
!
    ...
    DO I = 1, IIPAR
       ...
       ! SDE 2015-08-17 - +180 gets changed to -180, resulting in
       ! negative dx. Fix this
       IF (xedgeC_e < xedgeC_w) xedgeC_e = xedgeC_e + 360.0e+0_fp
...
#if defined( GRIDF40 ) || defined( GRIDM23 ) || defined( GRIDM40 )
             II      = indLon(III)
#else
