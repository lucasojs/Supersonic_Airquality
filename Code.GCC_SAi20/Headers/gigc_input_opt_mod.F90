...
!
  ...
  TYPE, PUBLIC :: OptInput
     ...
     LOGICAL                     :: LFDH
     LOGICAL                     :: LREADDYN
     LOGICAL                     :: LH2ORad_Expt
     REAL(fp)                    :: H2ORad_Level
     LOGICAL                     :: LConRad_Expt
     REAL(fp)                    :: ConRad_Level
...
!
    ...
    Input_Opt%LCONTRAILS             = .FALSE.
    Input_Opt%LCON_FJX               = .FALSE.
    Input_Opt%LCON_RRTMG             = .FALSE.
    Input_Opt%LCON_HET               = .FALSE.
    Input_Opt%CON_SCALE              = 1e+0_fp
    ...
    Input_Opt%LLSYEAR                = 0
    Input_Opt%JDClock                = 0.0e+0_f8
    Input_Opt%LFUTURECFC             = .FALSE.
    Input_Opt%LRCPLLS                = .FALSE.
    Input_Opt%LFIXLLS                = .FALSE.
    Input_Opt%RCPNAME                = ''
    Input_Opt%LREADCH4               = .FALSE.
    Input_Opt%LWRITECH4              = .FALSE.
    Input_Opt%LCUSTOMCH4             = .FALSE.
    Input_Opt%TARGCH4                = 0.e+0_fp
    Input_Opt%CH4ROOT                = ''
    ...
    Input_Opt%LCPTH2O                = .FALSE.
    Input_Opt%CPTH2OMIN              = 0e+0_fp
    Input_Opt%CPTH2OMAX              = 0e+0_fp
    Input_Opt%LO3FJX                 = .FALSE.
    Input_Opt%LAREAL_CLOUD           = .FALSE.
    ...
    Input_Opt%TS_RAD                 = 0
    Input_Opt%LVARCO2                = .FALSE.
    Input_Opt%CO2FILE                = ''
    Input_Opt%LFDH                   = .FALSE.
    Input_Opt%LREADDYN               = .FALSE.
    Input_Opt%LH2ORAD_EXPT           = .FALSE.
    Input_Opt%H2ORAD_LEVEL           = -1.0
    Input_Opt%LConRAD_EXPT           = .FALSE.
    Input_Opt%ConRAD_LEVEL           = -1.0
