...
#elif defined( MODELE )
# if defined( GRIDF40 ) || defined( GRIDM40 )
  CHARACTER(LEN=15),   PARAMETER :: DEF_MET = 'modele40'
# elif defined( GRIDM23 )
  CHARACTER(LEN=15),   PARAMETER :: DEF_MET = 'modele23'
#endif
#else
  ...
  CHARACTER(LEN=15),   PARAMETER :: DEF_RES = 'gissf'
#elif defined( GRIDM23 ) || defined( GRIDM40 )
  CHARACTER(LEN=15),   PARAMETER :: DEF_RES = 'gissm'
#else
